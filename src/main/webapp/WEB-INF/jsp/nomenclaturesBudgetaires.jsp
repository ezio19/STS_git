...
<section id="main">
    ...
    <section id="content">
        <div class="container">
            <c:import url="./nomenclatures/list_comptes.jsp" >
                <c:param name="listComptes" value="${listComptes}"/>
            </c:import>
            <c:import url="./nomenclatures/compte_detail.jsp">
                <c:param name="listComptes" value="${listComptes}"/>
            </c:import>
            <c:import url="./nomenclatures/compte_create.jsp">
            </c:import>
        </div>
    </section>
</section>
...
<script type="text/javascript" src="js/functions_nomenclatures_budgetaires.js"></script>
