...
<header id="header" class="clearfix" data-current-skin="blue">
    ...
    <ul class="header-inner">
        ...
        <li class="logo hidden-xs">
            <a href="">Syst√®me Budg√©taire et Comptable</a>
        </li>
        ...
        <div id="mCSB_1" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical_horizontal mCSB_outside" tabindex="0">
            <div id="mCSB_1_container" class="mCSB_container mCS_x_hidden mCS_no_scrollbar_x"
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu">
                        <a href="#"><i class="zmdi zmdi-view-compact"></i> Dotation SupplÈmentaire</a>

                        <ul>
                           <li><a href="DotSupp.jsp">Ajouter Dotation supplÈmentaire</a></li>
                            <li><a href="NewFile.jsp">Annuler Dotation supplÈmentaire</a></li>
                            <li><a href="top-mainmenu.html">Mainmenu on top</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="sub-menu active toggled">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="Annul_Dotations.html">Annulation d'une dotation budg√©taire</a></li>
                        </ul>
                    </li>
                    <li class="sub-menu">
        ...
        <div class="container">
            ...
            du cardview d'android
             ...
             <!-- -->
              ...
              <div class="card cardInitiale" style="display:none">
                     ...
                     <div id="data-table-command-header" class="bootgrid-header container-fluid">
                        ...
                        <div class="row">
							...
							<div class="row">
								...
								<button type="button" classe="AjouterDot"  > Ajouter</button>
							</div>
             ...
             <div class="card cardGlobale" style="">
            ...
            <div class="card list-comptes">
                ...
                <div class="card-contenu">
					...
					<form method="POST">
                        <div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-6" >
								<label>Ajouter Dotation</label>
							    <button type="button" class="showingInfos btn btn-icon command-edit waves-effect waves-circle" data-row-id="10253"><span class="zmdi zmdi-assignment"></span></button>
                    ...
                    <table id="data-table-command" class="table table-striped table-vmiddle bootgrid-table" aria-busy="false">
                        ...
                        <tr>
					         ...
					         <th data-column-id="Section" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Section</span><span class="zmdi icon "></span></a></th>
					         
					        <th data-column-id="Chapitre" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Chapitre</span><span class="zmdi icon "></span></a></th>
							<th style="" class="text-left" data-column-id="Code"><a href="javascript:void(0);" class="column-header-anchor sortable"><span  class="text">Code</span><span class="zmdi icon "></span></a></th>
                    
							<th data-column-id="LibellÈ" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Libell√©</span><span class="zmdi icon "></span></a></th>
                            <th data-column-id="Montant" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Montant</span><span class="zmdi icon "></span></a></th>
                            <th data-column-id="Monnaie" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Monnaie</span><span class="zmdi icon "></span></a></th>
                            <th data-column-id="Etat" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Etat</span><span class="zmdi icon "></span></a></th>
                            
                            <!--<th data-column-id="Objet" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Objet</span><span class="zmdi icon "></span></a></th>
                            <th data-column-id="Date"  class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="Date">Date</span><span class="zmdi icon "></span></a></th>
                            <th data-column-id="Observation" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Observation</span><span class="zmdi icon "></span></a></th>-->
                            <th data-column-id="Operations" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Operations</span><span class="zmdi icon "></span></a></th>
                        </tr>
                        </thead>
                        ...
                        <!--Les ligne du tableau -->
                         <c:forEach items="${liste}" var="c">
							...
							<button type="button" class="showingInfos btn btn-icon command-edit waves-effect waves-circle" data-raw-id="${c.id}"><span class="zmdi zmdi-assignment" data-row-id="0"></span></button>
                            <button type="button"  class="editingInfors btn btn-icon command-edit waves-effect waves-circle" ><span class="zmdi zmdi-edit"data-raw-id="${c.id}"></span></button>
                            <button type="button" class="compte-suppr extern btn btn-icon command-delete waves-effect waves-circle" ><span class="zmdi zmdi-delete"data-raw-id="${c.id}"></span></button>
							</td>	 
                    ...
                    <div id="data-table-command-footer" class="bootgrid-footer container-fluid">
                        <div class="row">
                            ...
                            <div class="col-sm-6 infoBar">
                                <div class="infos">affichage de 1 √† 10 <des></des> 20 entr√©es</div>
                            </div>
                        </div>
                    </div>
                </div>
            	...
            	<div class="card list-comptes decision">
				<div class="card-header">
                    <h2>DÈcision                     </h2>
				</div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                 <div class="btn-group" role="group">
												    <button type="submit" class="btn btn-default submit-decision">Submit</button>
												 </div> 
												   </div>     
                                            </div>
                                        </div>
                ...
                <div class="card-header">
                    <div class="row">
                       <div class="col-sm-9">
                            ...
                            <div class=""></div>
                            <button class="btn btn-login compte-mod-save" style="display:none" >Ajouter Dotation</button>
                            <button class="btn btn-login compte-mod" style="display:none">Modifier Dotation</button>
                            <button class="btn btn-login btn-danger compte-suppr intern" style="display:none">Annuler Dotation</button>
                                    ...
                                    <div id="collapseOne" class="collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Section</label>
                                                    <input id="Section_dot1"  placeholder="Fonctionnement" class="form-control compte"></input>        
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>Chapitre</label>
                                                    <input id="Chapitre_dot1"  placeholder="IMPOT&TAXES" class="form-control compte"></input>        
                                                </div>
                                                <div class="col-sm-4">
                                                    <label>Etat</label>
                                                    <input id="Etat_dot1"  placeholder="Actif ou AnnulÈe" pattern="Actif|AnnulÈe" class="form-control compte"></input>        
                                                </div>
                                    ...
                                    <div id="collapseTwo" class="collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                           <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Code</label>
                                                    <input id="Code_dot1" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                                
                                                <div class="col-sm-4">
                                                    <label>Libell√©</label>
                                                    <input id="Libell√©_dot1" placeholder="6" class="form-control compte"></input>        
                                                </div>
												<div class="col-sm-4">
                                                    <label>Montant</label>
                                                    <input id="Montant_dot1" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                            </div>
			 ...
			 <div class="card compte-detail1" style="display:none">
                <!--L'entete de la page' -->
                ...
                <div class="card-contenu compte-detail1">
                   <div class="panel-group p-l-20" role="tablist" aria-multiselectable="true">
                                <div class="panel panel-collapse">
                                    <div class="panel-heading active" role="tab" id="headingOne">
                                        <h4 class="panel-title">
                                    ...
                                    <div id="collapseOne" class="collapse in" role="tabpanel" aria-labelledby="headingOne" aria-expanded="true">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Chapitre</label>
                                                    <input id="Chapitre_dot" placeholder="IMPOT&TAXES" class="form-control "></input>        
                                                </div>
                                    ...
                                    <div id="collapseTwo" class="collapse in" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                           <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Code</label>
                                                    <input id="Code_dot" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                                
                                                <div class="col-sm-4">
                                                    <label>Libell√©</label>
                                                    <input id="Libell√©_dot" placeholder="6" class="form-control compte"></input>        
                                                </div>
												<div class="col-sm-4">
                                                    <label>Montant</label>
                                                    <input id="Montant_dot" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                            </div>
                                    ...
                                    <div id="collapseThree" class="collapse in" role="tabpanel" aria-labelledby="headingThree">
                                        <div class="panel-body">
                                              <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Numero</label>
                                                    <input id="Numero_decis" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                                
                                                <div class="col-sm-8">
                                                    <label>Objet</label>
                                                    <input id="Objet_decis" placeholder="6" class="form-control compte"></input>        
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label>Date</label>
                                                    <input id="Date_decis"  type="date" class="form-control compte"></input>        
                                                </div>
												
												<div class="col-sm-8">
                                                    <label>Observation</label>
                                                    <input id="Observation_decis"  class="form-control compte"></input>        
                                                </div>
                                            </div>
                                        </div>
                                    </div>
