                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-9">
                            ...
                            <div class=""></div>
                            <button class="btn btn-login compte-create-submit">Modifier la Rubrique</button>
                            <button style="display: none" class="btn btn-login compte-create-submit">Enregistrer les
                                modifications
                            </button>
                            ...
                            <div id="collapseOne1" class="collapse in" role="tabpanel" aria-labelledby="headingOne1"
                                ...
                                <div class="panel-body">
                                    <div id="section_creation_form" class="row">
                                        <div class="col-sm-4">
                                            <div class="fg-line">
                                                <input id="creat_input_coderub" placeholder="${rubrique.getCodeRubrique()}"class="form-control compte" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="fg-line">
                                                <input id="creat_input_designation" placeholder="${rubrique.getDesignation()}" class="form-control compte" readonly>
                                            </div>
                                        </div>

                                        <div style="display: none" class="col-sm-8">
                                            <br/>
                                            <select class="selectpicker" title="Chapitre" id="chapitre-select-section"
                                                    data-live-search="true">
                                            </select>
                                        </div>

                                        <div id="code_chapitre" class="col-sm-8">
                                            <br/>
                                            <br/>
                                            <div class="fg-line">
                                                <input placeholder="${rubrique.getChapitre().getCodeChapitre()}" class="form-control compte" readonly>
                                            </div>
                                        </div>
...
<script type="text/javascript" src="js/functions_rubriques.js"></script>
