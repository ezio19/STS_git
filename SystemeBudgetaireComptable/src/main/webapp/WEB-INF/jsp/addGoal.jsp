...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  ...
	  <!--  Nouveau code -->
     <form:form id="foorm" >
     	<input id="criteria" placeholder="critère de recherche"/>
     	<input type="submit" />
     </form:form> 
     <select id="resultActivities"></select>
    ...
    <script type="text/javascript">
		$("#foorm").submit(function(event){
			...
			event.preventDefault();
				...
				var json = { "name" : criteria };
				$.ajax({
					url: '<spring:url value="searchActivities.json"/>'/*$('#JsonPostForm').action*/,
					type: 'POST',
					dataType: 'json',
