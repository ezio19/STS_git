                   ...
                   <div class="card">
                        ...
                        <div class="card-body card-padding">
							...
							<div class="col-sm-3 m-b-20">
                                    <div class="form-group fg-line">
                                        <label> Statut</label>
                                         <form:input type="text"    placeholder="eg: 0001"  class="form-control input-mask" path="statut"/>
                                    </div>
                            </div>
							...
							<div class="row">
                             	 ...
                             	 <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Type</label>
                                       <form:input type="text" class="form-control input-mask"   placeholder="eg: 0001" path="type"/>
                                    </div>
                                ...
                                <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        ...
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="forme_juridique"/>
                                    </div>
                                  ...
                                  <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Nature</label>
                                        <form:input type="text"    placeholder="eg: 0001"  class="form-control input-mask" path="nature"/>
                                    </div>
                                ...
                                <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        ...
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="designation"/>
                                    </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Adresse</label>
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="adresse"/>
                                    </div>
                                ...
                                <div class="row">
                                 <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Wilaya</label>
                                       <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="wilaya"/>
                                    </div>
                                   ...
                                   <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Commune</label>
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="commune"/>
                                    </div>
                                ...
                                <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >CP</label>
                                        <form:input type="text"    placeholder="eg: 0001"  class="form-control input-mask" path="cp"/>
                                    </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        ...
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="tel"/>
                                    </div>
                                 ...
                                 <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >Fax</label>
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="fax"/>
                                    </div>
                                ...
                                <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        <label >E-mail</label>
                                        <form:input type="text"    placeholder="eg: 0001" class="form-control input-mask" path="email"/>
                                    </div>
                             ...
                             <div class="row">
                               ...
                               <div class="col-sm-3 m-b-20">
                                    ...
                                    <div class="form-group fg-line">
                                        ...
                                        <form:input type="text"    placeholder="eg: 0001"  class="form-control input-mask" path="registre_commerce"/>
                                    </div>
