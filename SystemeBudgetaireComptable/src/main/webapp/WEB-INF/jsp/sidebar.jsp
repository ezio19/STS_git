        ...
        <div id="mCSB_1_container" class="mCSB_container mCS_x_hidden mCS_no_scrollbar_x"
            ...
            <ul class="main-menu">
                ...
                <li class="sub-menu">
                    ...
                    <ul>
                        <li><a href="gestion_utilisateurs_utilisateurs.html"><i class="zmdi zmdi-face zmdi-hc-fw "></i>
                            Utilisateurs</a></li>
                        <li><a href="gestion_utilisateurs_fonctionnalites.html"><i
                                class="zmdi zmdi-lamp zmdi-hc-fw"></i> Fonctionnalites</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="nomenclatures_sections.html"><i class="zmdi zmdi-view-carousel zmdi-hc-fw"></i>
                            Sections</a></li>
                        <li><a href="nomenclatures_chapitres.html"><i class="zmdi zmdi-view-day zmdi-hc-fw"></i>
                            Chapitres</a></li>
                        <li><a href="nomenclatures_rubriques.html"><i class="zmdi zmdi-view-list-alt zmdi-hc-fw"></i>
                            Rubriques</a></li>
                        <li><a href="nomenclatures_comptables.html"><i class="zmdi zmdi-balance zmdi-hc-fw"></i>
                            Nomenclatures Comptables</a></li>
                        <li><a href="nomenclatures_budgetaires.html"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Comptes
                            Budgetaires</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul>
                        <sec:authorize access="hasAuthority('ROLE_USER')">
                            <li><a href="AllGuides.html"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i>Liste des
                                guides</a></li>
                        </sec:authorize>
                        <sec:authorize access="hasAnyAuthority('ROLE_USER')">
                            <li><a href="NewGuide.html"><i class="zmdi zmdi-truck zmdi-hc-fw"></i>Ajouter un guide</a>
                            </li>
                        </sec:authorize>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul>
                        <li class="sub-menu">
                            ...
                            <ul>
                                <li><a href="addDemandeTransfert.html"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Un
                                    seul Compte</a></li>
                                <li><a href="addDemandePlusieursCompte.html"><i class="zmdi zmdi-truck zmdi-hc-fw"></i>
                                    Plusieurs Comptes</a></li>
                            </ul>
                        </li>


                        <li><a href="addDemandeTransfertExterne.html"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Demande
                            Transfert Externe</a></li>
                        <sec:authorize access="hasAnyAuthority('ROLE_VOIR_DISPONIBIITE_INTRA', 'ROLE_ADMIN')">
                            <li><a href="AllDemandes.html"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i> Liste des
                                demandes de transfert Interne</a></li>
                        </sec:authorize>
                        <sec:authorize access="hasAnyAuthority('ROLE_VOIR_DISPONIBIITE_INTER', 'ROLE_ADMIN')">
                            <li><a href="AllDemandesExterne.html"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i> Liste
                                des demandes de transfert externe</a></li>
                        </sec:authorize>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    <a href="#"><i class="zmdi zmdi-view-compact"></i> Operations</a>
                    <ul>
                        <sec:authorize access="hasAnyAuthority('ROLE_CREER_OPERATION_BUDGETAIRE', 'ROLE_ADMIN')">
                            <li><a href="opbudg.html"><i class="zmdi zmdi-city-alt zmdi-hc-fw"></i>Operations Budgeaires</a>
                            </li>
                        </sec:authorize>
                        <sec:authorize access="hasAnyAuthority('ROLE_CREER_OPERATION_COMPTABLE', 'ROLE_ADMIN')">
                            <li><a href="opcompt.html"><i class="zmdi zmdi-truck zmdi-hc-fw"></i>Operations
                                Comptables</a></li>
                        </sec:authorize>
