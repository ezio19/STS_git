...
<section id="main">
    ...
    <section id="content">
        <div class="container">
            <c:import url="./nomenclatures_comptables/list_nomenclatures_comptables.jsp" >
                <c:param name="listNomenclaturesComptables" value="${listNomenclaturesComptables}"/>
            </c:import>

            <c:import url="./nomenclatures_comptables/nomenclature_comptable_detail.jsp">
                <c:param name="listNomenclaturesComptables" value="${listNomenclaturesComptables}"/>
            </c:import>

            <c:import url="./nomenclatures_comptables/nomenclature_comptable_create.jsp">
            </c:import>

            <c:import url="./nomenclatures_comptables/compte_budgetaire_create.jsp">
            </c:import>
...
<script type="text/javascript" src="js/functions_nomenclatures_comptables.js"></script>
