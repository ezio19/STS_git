...
<div class="card compte-detail" style="">
                ...
                <div class="card-header">
                    <div class="row">
                       <div class="col-sm-9">
                            <h2>Dotations Supplémentaire
                                <small>Affichage Des Dotations Supplémentaire</small>
                            </h2>
                       ...
                       <div class="col-sm-3" dir="rtl">
                           <a href="index11.html" class="btn btn-login btn-danger btn-float waves-effect waves-circle waves-float compte-return-btn"><i class="zmdi zmdi-arrow-left"></i></a>
                       </div>
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                   ...
                                                   <form:input path="section" id="Section_dot1" required="required" placeholder="Fonctionnement" class="form-control compte typeahead" pattern="[a-zA-Z]*+[ ]*"></form:input>        
                                                </div>
                                                <div class="col-sm-4">
                                                     <form:label  path="chapitre">Chapitre:</form:label>
                                                    <form:input path="chapitre" id="Chapitre_dot1" required="required"  placeholder="IMPOT&TAXES" class="form-control compte typeahead1" pattern="[a-zA-Z]*+[ ]*"></form:input>        
                                                </div>
                                                <div class="col-sm-4">
                                                     <form:label  path="rubrique">Rubrique</form:label>
                                                    <form:input path="rubrique" id="Etat_dot1" required="required"   class="form-control compte typeahead1"></form:input>        
                                                </div>
                                        ...
                                        <div class="panel-body">
                                           <div class="row">
                                                <div class="col-sm-4">
                                                    ...
                                                    <form:input path="montant"  id="Montant_dot1" required="required"  placeholder="6" class="form-control compte" pattern="[0-9]{2,}"></form:input>        
                                                </div>
												<div class="col-sm-4">
                                                     <form:label path="codeMonnais"  >Code Monnais</form:label>
                                                     <form:select id="Code_dot1" path="codeMonnais" >
                                                    <form:option label="EUR" value="EUR"></form:option>
                                                    <form:option label="DOL" value="DOL"></form:option>
                                                    <form:option label="DZD" value="DZD"></form:option>
