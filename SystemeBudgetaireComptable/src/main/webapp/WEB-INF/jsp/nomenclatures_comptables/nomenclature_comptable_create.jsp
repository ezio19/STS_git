...
<div class="card section-create" style="display:none">
    ...
    <div class="card-header">
        <div class="row">
            <div class="col-sm-9">
                <h2>Fiche Nomenclature
                    <small>Affichage des informations sur la Nomeclature</small>
                </h2>

                <div class=""></div>
                <button class="btn btn-login compte-create-submit">Créer la Nomenclature
                </button>
                ...
                <div id="collapseOne1" class="collapse in" role="tabpanel" aria-labelledby="headingOne1"
                    ...
                    <div class="panel-body">
                        <div id="section_creation_form" class="row">
                            <div class="col-sm-4">
                                <div class="fg-line">
                                    <input id="creat_input_code_sect" placeholder="Numéro" class="form-control compte">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="fg-line">
