                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-3" dir="rtl">
                                <a href="nomenclatures_strcutures.html"
                                ...
                                <div id="collapseOne1" class="collapse in" role="tabpanel" aria-labelledby="headingOne1"
                                    ...
                                    <div class="panel-body">
                                        <div id="section_creation_form" class="row">
                                            <div class="col-sm-4">
                                                <div class="fg-line">
                                                    <input id="creat_input_code_struct"
                                                           placeholder="${structure.getCodeStructure()} "
                                                           class="form-control compte" readonly>
                                                </div>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="fg-line">
                                                    <input id="creat_input_nom_struct"
                                                           placeholder="${structure.getNom()}"
                                                           class="form-control compte" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-8">
                                                <br/>
                                                <div class="fg-line">
                                                    <input id="creat_input_address_struct"
                                                           placeholder="${structure.getAdresse()}"
                                                           class="form-control compte" readonly>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript" src="js/functions_structures_show.js"></script>
