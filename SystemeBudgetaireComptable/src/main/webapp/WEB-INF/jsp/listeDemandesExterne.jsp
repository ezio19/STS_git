...
<head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>LISTE DES DEMANDES DE TRANSFERT EXTERNE</title>
        ...
        <header id="header" class="clearfix" data-current-skin="blue">
			...
			<ul class="header-inner">
                ...
                <li class="logo hidden-xs">
                    <a href="index-2.html">LISTE DE DEMANDES DE TRANSFERT INTERNE</a>
                </li>
				 <!-- Top Search Content -->
		...
		<section id="main">
			...
			<section id="content">
				<div class="container">
					...
					<input type="text" name="num_structure" id="num_structure"> </input>
					...
					<input type="text" name="date_demande" id="date_demande"> </input>
                        ...
                        <tr>
                            ...
                            <th data-column-id="CompteLabel" class="text-left" style=""><a href="javascript:void(0);" class="column-header-anchor sortable"><span class="text">Structure</span><span class="zmdi icon "></span></a></th>
                       ...
                       <c:forEach items="${listeExterne}" var="c" varStatus="statut">
                          
                            <td id="num_demande" class="text-left" style=""> ${c.id}</td> 
                              <td id="num_rubrique" class="text-left" style="">${c.num_structure}</td>
							...
							<table  id="tableDemande" class="table table-bordered" style="margin-top: 65px;">
									...
									<c:forEach items="${demandesExterne}" var="dem" varStatus="statut">
